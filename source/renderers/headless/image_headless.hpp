...
class Image_Headless : public Image {
  public:
    Image_Headless(std::string filePath, bool fromScratchProject = true, bool bitmapHalfQuality = false);

    Image_Headless(std::string filePath, mz_zip_archive *zip, bool bitmapHalfQuality = false);
