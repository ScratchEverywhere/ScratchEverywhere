...
std::map<std::string, FontData> TextObjectGL2D::fonts;

TextObjectGL2D::TextObjectGL2D(std::string txt, double posX, double posY, std::string fontPath)
...
bool TextObjectGL2D::loadFont(std::string fontPath) {
...
void TextObjectGL2D::setText(std::string txt) {
    if (text != txt) {
        text = txt;
        setDimensions();
    }
...
void TextObjectGL2D::setDimensions() {
