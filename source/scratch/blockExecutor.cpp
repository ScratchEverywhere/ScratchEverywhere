...
void BlockExecutor::registerHandlers() {
    ...
    valueHandlers = {
        ...
        {"wedo2_menu_MOTOR_DIRETCION", [](Block &block, Sprite *sprite) { return Value(Scratch::getFieldValue(block, "MOTOR_DIRECTION"));}},
        {"wedo2_menu_OP", [](Block &block, Sprite *sprite) { return Value(Scratch::getFieldValue(block, "OP"));}},
        {"wedo2_menu_TILT_DIRECTION_ANY", [](Block &block, Sprite *sprite) { return Value(Scratch::getFieldValue(block, "TILT_DIRETCION_ANY"));}},
        {"wedo2_menu_TILT_DIRECTION", [](Block &block, Sprite *sprite) { return Value(Scratch::getFieldValue(block, "TILT_DIRETCION"));}},
