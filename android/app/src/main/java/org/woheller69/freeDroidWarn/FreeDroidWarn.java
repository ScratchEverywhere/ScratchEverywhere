...
public class FreeDroidWarn {
    ...
    public static void showWarningOnUpgrade(Context context, int buildVersion) {
        ...
        if (buildVersion > versionCode) {
            ...
            alertDialogBuilder.setMessage(R.string.freeDroid_dialog_Warning);
            alertDialogBuilder.setNegativeButton(context.getString(R.string.freeDroid_dialog_more_info), (dialog, which) -> context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://keepandroidopen.org"))));
            ...
            alertDialogBuilder.setNeutralButton(context.getString(R.string.freeDroid_solution), (dialog, which) -> context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/woheller69/FreeDroidWarn?tab=readme-ov-file#solutions"))));
