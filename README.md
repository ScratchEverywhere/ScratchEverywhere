...
When creating a Windows NSIS Installer for Scratch Everywhere!, see [this 
guide](scratch-win32/scratch-pc/README.md). When creating a macOS App Bundle 
for Scratch Everywhere!, see [this guide](scratch-macos/scratch-pc.app/Contents/MacOS/README.md).
