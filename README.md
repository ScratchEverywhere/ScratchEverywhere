...
Logotipo do Scratch Everywhere! Versão de lançamento Discord Commits Um ambiente de execução em desenvolvimento, feito em C++, com o objetivo de levar a maioria dos projetos do Scratch 3 para consoles de jogos da 6ª à 8ª geração, plataformas portáteis e muito mais! Ambiente de execução executando um projeto do Scratch no Wii U, Wii e 3DS (O jogo mostrado é Hopper Heroes, de pepper-prepper) Aviso O Scratch Everywhere! ainda está em desenvolvimento. Nem todos os projetos funcionarão corretamente e alguns recursos do Scratch original não são suportados ou são suportados apenas em determinadas plataformas. Consulte a página de limitações para obter mais informações. Documentação A maior parte da documentação sobre como usar o Scratch Everywhere! pode ser encontrada no site: https://ScratchEverywhere.github.io. Recursos O Scratch Everywhere! oferece suporte a vários recursos específicos de consoles, como suporte a duas telas no 3DS e DS, além de obter nomes de usuário diretamente do console. Além disso, também oferece suporte a vários aprimoramentos de outros editores Scratch modificados, como a remoção de limites de clones e limites de palco, bem como a execução de projetos em taxas de quadros personalizadas. Também possui algumas funcionalidades exclusivas, incluindo a capacidade de permitir que projetos carreguem outros projetos e extensões personalizadas que podem expandir ainda mais suas capacidades. Para obter mais informações sobre esses recursos, consulte a página de Recursos no site. Instalação As instruções de instalação do Scratch Everywhere! podem ser encontradas no site. O Scratch Everywhere! não inclui nenhum projeto do Scratch. Você precisará baixá-los manualmente do site do Scratch e colocá-los em seu console. O ScratchBox possui muitos projetos que funcionam bem com o Scratch Everywhere!. Controles Controles Mouse 3DS, PS Vita, Wii U GamePad, Switch portátil: Use a tela sensível ao toque. Wii Remote: Use a barra de sensores do Wii para controlar o mouse. Outros controladores: Entre no Modo Mouse mantendo pressionado o botão L. Use o D-pad para mover o mouse e pressione R para clicar. Configurações O comportamento do ambiente de execução pode ser alterado com várias configurações. Isso inclui alterar o mapeamento de botões para teclas no projeto ou modificar o comportamento de alguns blocos. Consulte o site para obter uma lista de todas as configurações e suas funções. Compilação Existem dois métodos principais para compilar o Scratch Everywhere: usando o Docker e compilação manual. Ambos os métodos são descritos no site. Além disso, você pode empacotar um projeto com o Scratch Everywhere! e criar um aplicativo ou jogo independente com o ambiente de execução! Colaboradores Agradecemos a todos que ajudaram no desenvolvimento (e em outros aspectos) deste projeto! (Feito com contrib.rocks) Se você quiser contribuir com o Scratch Everywhere!, consulte nosso guia de contribuição. Aviso Legal Este projeto não tem qualquer vínculo com o Scratch, a Equipe Scratch ou as empresas ou organizações controladoras das plataformas suportadas.
