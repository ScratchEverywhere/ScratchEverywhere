...
struct SE_EXPORT ExtensionSetting {
    std::string name;
...
SE_EXPORT nonstd::expected<std::unique_ptr<Extension>, std::string> parseMetadata(std::istream &data);
} // namespace extensions
