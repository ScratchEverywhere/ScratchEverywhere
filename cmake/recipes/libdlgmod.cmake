...
function(_recipe_libdlgmod_source)
	...
	elseif(CMAKE_SYSTEM_NAME MATCHES "^(Linux|FreeBSD|DragonFly|NetBSD|OpenBSD|SunOS)$" AND NOT ANDROID AND NOT WEBOS)
		if(CMAKE_SYSTEM_NAME MATCHES "^(Linux|FreeBSD)$" AND NOT ANDROID AND NOT WEBOS)
			find_package(PkgConfig REQUIRED)
			pkg_check_modules(DBUS REQUIRED IMPORTED_TARGET dbus-1)
			add_library(libdlgmod STATIC "${LIBDLGMOD_DIR}/xlib/libdlgmod.cpp" "${LIBDLGMOD_DIR}/general/apiprocess/process.cpp" "${LIBDLGMOD_DIR}/general/xprocess.cpp" "${LIBDLGMOD_DIR}/general/lodepng.cpp" "${LIBDLGMOD_DIR}/xlib/nfd/src/nfd_portal.cpp")
			target_link_libraries(libdlgmod PRIVATE PkgConfig::DBUS)
		else()
	...
	elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux")
		...
		target_link_libraries(libdlgmod PUBLIC X11 dbus-1 pthread)
	elseif(CMAKE_SYSTEM_NAME STREQUAL "FreeBSD" OR CMAKE_SYSTEM_NAME STREQUAL "DragonFly")
		target_include_directories(libdlgmod PUBLIC "${LIBDLGMOD_DIR}/xlib/nfd/src/include" "/usr/local/include")
		target_link_directories(libdlgmod PUBLIC "/usr/local/lib")
		target_link_libraries(libdlgmod PUBLIC X11 dbus-1 kvm pthread)
