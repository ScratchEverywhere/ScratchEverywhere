...
function(_dep_source_SDL2)
	...
	if(NOT SE_WINDOWING STREQUAL "sdl2" AND NOT SE_RENDERER STREQUAL "sdl2") # Audio Only
		set(SDL2_OPTIONS "SDL_COCOA OFF" "SDL_RENDER_METAL OFF" "SDL_OPENGL OFF" "SDL_JOYSTICK OFF" "SDL_HAPTIC OFF" "SDL_RPI OFF" "SDL_X11 OFF" "SDL_WAYLAND OFF" "SDL_DIRECTX OFF" "SDL_KMSDRM OFF" "SDL_VULKAN OFF" "SDL_VIVANTE OFF" "SDL_RENDER_D3D OFF" "SDL_OFFSCREEN OFF" "SDL_HIDAPI OFF" "SDL_UNIX_CONSOLE_BUILD ON")
  else()
