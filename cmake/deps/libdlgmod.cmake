...
function(_dep_source_libdlgmod)
	...
	if(DEFINED SE_WINDOWING)
		if(SE_WINDOWING STREQUAL "sdl1")
			...
			if(SDL_FOUND)
				target_include_directories(libdlgmod PUBLIC ${SDL_INCLUDE_DIRS})
		...
		elseif(SE_WINDOWING STREQUAL "sdl2")
			...
			if(SDL2_FOUND)
				target_include_directories(libdlgmod PUBLIC ${SDL2_INCLUDE_DIRS})
				if(CMAKE_SYSTEM_NAME STREQUAL "Linux" AND NOT WEBOS)
		...
		elseif(SE_WINDOWING STREQUAL "sdl3")
			...
			if(SDL3_FOUND)
				target_include_directories(libdlgmod PUBLIC ${SDL3_INCLUDE_DIRS})
				if(CMAKE_SYSTEM_NAME STREQUAL "Linux" AND NOT WEBOS)
