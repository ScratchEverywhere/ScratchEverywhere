...
```
When distributing, this 'README.md' is not necessary, as it is only for information purposes, and it can be deleted if you don't want it in the bundle.
