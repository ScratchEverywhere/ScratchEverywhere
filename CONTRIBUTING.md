...
This section guides you through submitting an enhancement suggestion for Scratch
Everywhere!, **including completely new features and minor improvements to
...
- Read the [documentation](https://ScratchEverywhere.github.io) carefully and
  find out if the functionality is already planned.
- Perform a
  [search](https://github.com/ScratchEverywhere/ScratchEverywhere/issues) to see
...
[GitHub issues](https://github.com/ScratchEverywhere/ScratchEverywhere/issues).
...
- **Explain why this enhancement would be useful** to most Scratch Everywhere!
